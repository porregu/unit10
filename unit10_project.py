...
main_surface = pygame.display.set_mode((900, 500), 0, 32)  # this est the surface of the window
...
space = 5  # space between the bricks
brick_with = (main_surface.get_width() - space * 10) / 9  # is the with of the brick
x_pos = 5  # space on the x axes between bricks
y_pos = 480  # the position of the y
for x in range(9):  # a loop that repeats until it finish the program making 9 bricks
